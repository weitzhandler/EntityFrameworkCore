...
WHERE ([g].[Discriminator] IN (N'Officer', N'Gear') AND ([g].[HasSoulPatch] = 1)) AND (@_outer_Id = [g].[SquadId])");
        ...
        public override void Order_by_anonymous_type1()
        {
            base.Order_by_anonymous_type1();
...
ORDER BY [s].[Name] DESC");
        ...
        public override void Order_by_anonymous_type2()
        {
            base.Order_by_anonymous_type2();

            AssertSql(
                @"SELECT [s].[Id], [s].[InternalNumber], [s].[Name]
FROM [Squads] AS [s]
ORDER BY (SELECT 1) DESC, [s].[Name] DESC, [s].[Id] DESC");
        }
...
ORDER BY [t].[c], [t].[Id]");
        ...
        public override void Include_with_order_by_anonymous_type1()
        {
            base.Include_with_order_by_anonymous_type1();

            AssertSql(
                @"SELECT [s].[Id], [s].[InternalNumber], [s].[Name]
FROM [Squads] AS [s]
ORDER BY (SELECT 1), [s].[Name], [s].[Id]",
                //
                @"SELECT [s.Members].[Nickname], [s.Members].[SquadId], [s.Members].[AssignedCityName], [s.Members].[CityOrBirthName], [s.Members].[Discriminator], [s.Members].[FullName], [s.Members].[HasSoulPatch], [s.Members].[LeaderNickname], [s.Members].[LeaderSquadId], [s.Members].[Rank]
FROM [Gears] AS [s.Members]
INNER JOIN (
    SELECT [s0].[Id], 42 AS [c], [s0].[Name]
    FROM [Squads] AS [s0]
) AS [t] ON [s.Members].[SquadId] = [t].[Id]
WHERE [s.Members].[Discriminator] IN (N'Officer', N'Gear')
ORDER BY [t].[c], [t].[Name], [t].[Id]");
        ...
        public override void Include_with_order_by_anonymous_type2()
        {
            base.Include_with_order_by_anonymous_type2();

            AssertSql(
                @"SELECT [s].[Id], [s].[InternalNumber], [s].[Name]
FROM [Squads] AS [s]
ORDER BY [s].[Name], (SELECT 1), (SELECT 1), (SELECT 1), [s].[Id]",
                //
                @"SELECT [s.Members].[Nickname], [s.Members].[SquadId], [s.Members].[AssignedCityName], [s.Members].[CityOrBirthName], [s.Members].[Discriminator], [s.Members].[FullName], [s.Members].[HasSoulPatch], [s.Members].[LeaderNickname], [s.Members].[LeaderSquadId], [s.Members].[Rank]
FROM [Gears] AS [s.Members]
INNER JOIN (
    SELECT [s0].[Id], [s0].[Name], 1 AS [c], 2 AS [c0], 3 AS [c1]
    FROM [Squads] AS [s0]
) AS [t] ON [s.Members].[SquadId] = [t].[Id]
WHERE [s.Members].[Discriminator] IN (N'Officer', N'Gear')
...
ORDER BY [t].[c], [t].[Id]");
        ...
        public override void Include_groupby_anonymous_type()
        {
            base.Include_groupby_anonymous_type();
